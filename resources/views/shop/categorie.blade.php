@extends('shop')<!-- Héritage du template "shop.blade"-->
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            @foreach($category->childrens as $children)
                <li class="breadcrumb-item active" aria-current="page"><a href="{{route('voir_produits_par_cat',['id'=>$children->id])}}">{{ $children->nom  }}</a></li>
            @endforeach
            @endif
        </ol>
    </nav>
